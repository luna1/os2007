...
inherit eutils multilib versionator linux-mod flag-o-matic nvidia-driver avviso
...
src_unpack() {
	...
	if cat /usr/src/linux/include/config/kernel.release |grep '2.6.27'; then
		einfo "Applying patches for Linux Kernel 2.6.27.x"
